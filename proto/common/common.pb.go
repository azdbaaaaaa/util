...
const (
	...
	ErrSubCode_err_sub_code_book_store_service      ErrSubCode = -202000
	ErrSubCode_err_sub_code_go_device_service       ErrSubCode = -203000
	ErrSubCode_err_sub_code_task_service            ErrSubCode = -204000
	ErrSubCode_err_sub_code_account_service         ErrSubCode = -205000
	ErrSubCode_err_sub_code_writing_contest_service ErrSubCode = -206000
)
...
var ErrSubCode_name = map[int32]string{
	...
	-202000: "err_sub_code_book_store_service",
	-203000: "err_sub_code_go_device_service",
	-204000: "err_sub_code_task_service",
	-205000: "err_sub_code_account_service",
	-206000: "err_sub_code_writing_contest_service",
}
...
var ErrSubCode_value = map[string]int32{
	...
	"err_sub_code_book_store_service":      -202000,
	"err_sub_code_go_device_service":       -203000,
	"err_sub_code_task_service":            -204000,
	"err_sub_code_account_service":         -205000,
	"err_sub_code_writing_contest_service": -206000,
}
...
var fileDescriptor_555bd8c177793206 = []byte{
	...
	,
}
